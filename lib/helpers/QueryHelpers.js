...
module.exports = (function() {
	...
	QueryHelpers.buildPrimaryKeyAlternateParameters = function(rstModel, request, id) {
		var params = {};
		...
		else
		{
			if(rstModel.options.hasOwnProperty('alternate'))
			{
				params.where = _.object([rstModel.options.alternate], [id])
			}
		}
