		    ...
		    callback: function(req, res, next, id) {
				sModel.model.find(QueryHelpers.buildPrimaryKeySearchParameters(sModel, req, id))
					.complete(function(err, obj) {
						...
						{
							// TODO: Get rid of this temporary workaround when sequelize works as it should.
							sModel.model.find(QueryHelpers.buildPrimaryKeyAlternateParameters(sModel, req, id))
								.complete(function(err2, obj2) {
									if(err2)
										return next(err);
									else if(!obj2) {
